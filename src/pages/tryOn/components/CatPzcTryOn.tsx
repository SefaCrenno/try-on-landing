...
import { tryOnWithCatPzc } from "../../../api/catPzcApi";
...
const CatPzcTryOn = () => {
  ...
  const handleTryOn = async () => {
    ...
    setIsLoading(true);
    try {
      const result = await tryOnWithCatPzc(
        {
  ...
  return (
    <div className="w-full bg-[#030303] py-20 lg:py-40 px-4 relative">
      ...
      <div className="relative z-10 max-w-screen-xl mx-auto px-4">
        ...
        <div className="mt-8 bg-white/5 p-6 rounded-xl border border-purple-600/20">
          ...
          <div className="mb-6 text-white">
            <label className="mr-2 font-medium">CFG Scale: {cfg}</label>
            <input
              type="range"
              value={cfg}
          ...
          <div className="mb-6 text-white">
            <label className="mr-2 font-medium">Steps: {steps}</label>
            <input
              type="range"
              value={steps}
